...
declare module '$env/static/private' {
	...
	export const PYENV_VIRTUALENVWRAPPER_PYENV_VERSION: string;
	...
	export const VIRTUALENVWRAPPER_VIRTUALENV_CLONE: string;
	...
	export const VIRTUALENVWRAPPER_LAZY_SCRIPT: string;
	export const PYENV_VIRTUALENVWRAPPER_PREFER_PYVENV: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		PATH: string;
		PYENV_VIRTUALENVWRAPPER_PYENV_VERSION: string;
		...
		VIRTUALENVWRAPPER_VIRTUALENV_CLONE: string;
		NVM_BIN: string;
		GOPATH: string;
		...
		VIRTUALENVWRAPPER_LAZY_SCRIPT: string;
		PYENV_VIRTUALENVWRAPPER_PREFER_PYVENV: string;
